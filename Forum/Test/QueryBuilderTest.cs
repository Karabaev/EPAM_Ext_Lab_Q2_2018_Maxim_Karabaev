namespace Test
{
    ...
    /// <summary>
    /// Тесты хелпера QueryBuilder. В качестве тестов в основном используется вывод возвращаемых комманд на экран. //todo pn не очень круто, потому что если у тебя будет 100 тестов, чот я сомневаюсь, что ты у каждого будешь просматривать лог.
    /// </summary>
    [TestClass]
